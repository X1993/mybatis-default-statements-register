...
public class DefaultEntityMateDataParser implements EntityMateDataParser{
    ...
    private TableSchemaResolutionStrategy defaultTableSchemaResolutionStrategy = TableSchemaResolutionStrategy.DATA_BASE;
    ...
    public Optional<EntityMateData> tryGetLoadedEntityMateData(Class<?> entityClass){
        Set<EntityMateData> entityMateDataSet = databaseEntityMateDataCache.values()
                ...
                .filter(entityMateData -> entityMateData != null)
                .collect(Collectors.toSet());
